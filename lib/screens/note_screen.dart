...
class _NoteScreenState extends State<NoteScreen> {
  ...
  Future<void> _addNote() async {
    ...
    await showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text(TranslationService.translate('add_note', lang)),
        content: Column(
          ...
          children: [
            TextField(
                ...
                decoration: InputDecoration(
                    labelText: TranslationService.translate('title', lang))),
            TextField(
                controller: contentController,
                decoration: InputDecoration(
                    labelText: TranslationService.translate('content', lang)),
                maxLines: 3),
          ],
        ),
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              if (titleController.text.isNotEmpty) {
                ...
                await StorageService.saveNotes(widget.activeFY, _notes);
  ...
  Future<void> _editNote(Note note, int index) async {
    ...
    await showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text(TranslationService.translate('edit_note', lang)),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            TextField(
  ...
  Future<void> _deleteNote(int index) async {
    ...
    final confirm = await showDialog<bool>(
      context: context,
      builder: (context) => AlertDialog(
        title: Text(TranslationService.translate('delete_note', lang)),
        content: Text(TranslationService.translate('delete_confirm_note', lang)),
        actions: [
          TextButton(
                      ...
                      child: ListTile(
                          ...
                          children: [
                            ...
                            ValueListenableBuilder<String>(
                              ...
                              builder: (context, dateType, _) {
                                ...
                                try {
                                  if (dateType == 'BS') {
                                    displayDate = NepaliDateTime.fromDateTime(DateTime.parse(note.date)).format('yyyy-MM-dd');
                                  }
                                } catch (e) {
                        ...
                        trailing: PopupMenuButton<String>(
                          ...
                          itemBuilder: (context) => [
                            PopupMenuItem(
                              value: 'edit',
                              child: Text(TranslationService.translate('edit', lang)),
                            ),
                            PopupMenuItem(
                              value: 'delete',
                              child: Text(TranslationService.translate('delete', lang)),
